						...
						<form action="" method="post">
							<div class="col-sm-12">
								...
								<div class="row form-group ">
									...
									<input type="file" name="file" id="aadharno" required>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="col-sm-4 form-group">
									...
									<div class="col-sm-4 form-group">
										<label>Occuption Income</label> 
						<input type="text"placeholder="Enter income here.." class="form-control"
											name="oincome" required>
									</div>
								</div>
									
									<div id="file" class="row"style="padding-top: 10px">
									...
									<div class="row"style="padding-top: 10px">
										 <label class="checkbox-inline">
									      <input type="checkbox" value="" id="opt_netbank"name="opt_netbank"required>Opt for Netbanking
									    </label>
							   	 </div>
							    <div class="row"style="padding-top: 10px">
									 <label class="checkbox-inline">
								      <input type="checkbox" value="" id="iagree" name="iagree" required>I Agree...
								 	</label>
							    </div>
